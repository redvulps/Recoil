...
function currentRendererSupportsUseSyncExternalStore() {
  ...
  const internals = /* $FlowFixMe[prop-missing] */
  ...
  const dispatcher = (_ReactCurrentDispatch = ReactCurrentDispatcher === null || ReactCurrentDispatcher === void 0 ? void 0 : ReactCurrentDispatcher.current) !== null && _ReactCurrentDispatch !== void 0 ? _ReactCurrentDispatch : ReactCurrentOwner === null || ReactCurrentOwner === void 0 ? void 0 : ReactCurrentOwner.currentDispatcher;
  const isUseSyncExternalStoreSupported = (dispatcher === null || dispatcher === void 0 ? void 0 : dispatcher.useSyncExternalStore) != null;
...
const unstable_batchedUpdates = reactDom.unstable_batchedUpdates || (callback => callback());
...
const {
  ...
  RecoilRoot_INTERNAL: RecoilRoot_INTERNAL$1,
...
const RecoilNodeInternal = Recoil_Node;
const {
...
var Recoil_index = {
  ...
  RecoilRootInternal: RecoilRoot_INTERNAL$1,
  RecoilNodeInternal
};
